...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> findBookingByBookerAndStatusOrderByStartDesc(User user, BookingStatus state);
    ...
    List<Booking> getBookingsForOwnerByStatus(Long ownerId, BookingStatus status);
