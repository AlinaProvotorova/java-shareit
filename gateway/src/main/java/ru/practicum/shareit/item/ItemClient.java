...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getOwnersItems(Long userId, int from, int size) {
    ...
    public ResponseEntity<Object> searchBy(String text, Long userId, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
